...
function mapUser(data: FirebaseFirestore.DocumentData, id: string): User {
  return {
    ...
    emergencyContactRelationship: (data.emergencyContactRelationship as string) ?? null,
    ...
    bankIfscCode: (data.bankIfscCode as string) ?? null,
    bankName: (data.bankName as string) ?? null,
    bankAccountHolderName: (data.bankAccountHolderName as string) ?? null,
    panNumber: (data.panNumber as string) ?? null,
    bankAccountType: (data.bankAccountType as string) ?? null,
...
function mapProject(data: FirebaseFirestore.DocumentData, id: string): Project {
  return {
    ...
    customFields: (data.customFields as Project["customFields"]) ?? null,
