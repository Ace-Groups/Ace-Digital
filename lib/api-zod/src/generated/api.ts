...
export const GetMyProfileResponse = zod.object({
  ...
  "bankAccountHolderName": zod.string().nullish().describe('Name as per bank records'),
 ...
 */
export const getDashboardResponseUpcomingDeadlinesItemCustomFieldsItemKeyMax = 80;

export const getDashboardResponseUpcomingDeadlinesItemCustomFieldsItemValueMax = 500;
...
export const GetDashboardResponse = zod.object({
  ...
  "key": zod.string().max(getDashboardResponseUpcomingDeadlinesItemCustomFieldsItemKeyMax),
  "value": zod.string().max(getDashboardResponseUpcomingDeadlinesItemCustomFieldsItemValueMax)
})).nullish(),
...
export const listProjectsResponseCustomFieldsItemKeyMax = 80;

export const listProjectsResponseCustomFieldsItemValueMax = 500;
...
export const ListProjectsResponseItem = zod.object({
  ...
  "githubUrl": zod.string().nullish(),
  "customFields": zod.array(zod.object({
  "key": zod.string().max(listProjectsResponseCustomFieldsItemKeyMax),
  "value": zod.string().max(listProjectsResponseCustomFieldsItemValueMax)
})).nullish(),
  "createdById": zod.number().nullish(),
  "createdAt": zod.string().optional()
})
...
export const createProjectBodyCustomFieldsItemKeyMax = 80;

export const createProjectBodyCustomFieldsItemValueMax = 500;
...
export const CreateProjectBody = zod.object({
  ...
  "customFields": zod.array(zod.object({
  "key": zod.string().max(createProjectBodyCustomFieldsItemKeyMax),
  "value": zod.string().max(createProjectBodyCustomFieldsItemValueMax)
})).optional()
})
...
export const getProjectResponseCustomFieldsItemKeyMax = 80;

export const getProjectResponseCustomFieldsItemValueMax = 500;
...
export const GetProjectResponse = zod.object({
  ...
  "githubUrl": zod.string().nullish(),
  "customFields": zod.array(zod.object({
  "key": zod.string().max(getProjectResponseCustomFieldsItemKeyMax),
  "value": zod.string().max(getProjectResponseCustomFieldsItemValueMax)
})).nullish(),
  "createdById": zod.number().nullish(),
  "createdAt": zod.string().optional()
})
...
export const updateProjectBodyCustomFieldsItemKeyMax = 80;

export const updateProjectBodyCustomFieldsItemValueMax = 500;
...
export const UpdateProjectBody = zod.object({
  ...
  "githubUrl": zod.string().nullish(),
  "customFields": zod.array(zod.object({
  "key": zod.string().max(updateProjectBodyCustomFieldsItemKeyMax),
  "value": zod.string().max(updateProjectBodyCustomFieldsItemValueMax)
})).nullish()
})

export const updateProjectResponseCustomFieldsItemKeyMax = 80;

export const updateProjectResponseCustomFieldsItemValueMax = 500;
...
export const UpdateProjectResponse = zod.object({
  ...
  "githubUrl": zod.string().nullish(),
  "customFields": zod.array(zod.object({
  "key": zod.string().max(updateProjectResponseCustomFieldsItemKeyMax),
  "value": zod.string().max(updateProjectResponseCustomFieldsItemValueMax)
})).nullish(),
  "createdById": zod.number().nullish(),
  "createdAt": zod.string().optional()
})
...
export const updateProjectStatusResponseCustomFieldsItemKeyMax = 80;

export const updateProjectStatusResponseCustomFieldsItemValueMax = 500;
...
export const UpdateProjectStatusResponse = zod.object({
  ...
  "githubUrl": zod.string().nullish(),
  "customFields": zod.array(zod.object({
  "key": zod.string().max(updateProjectStatusResponseCustomFieldsItemKeyMax),
  "value": zod.string().max(updateProjectStatusResponseCustomFieldsItemValueMax)
})).nullish(),
  "createdById": zod.number().nullish(),
  "createdAt": zod.string().optional()
})
...
export const CreateEmployeeBody = zod.object({
  ...
  "confirmBankAccountNumber": zod.string().optional().describe('Must match bankAccountNumber; not stored'),
  "bankIfscCode": zod.string().optional(),
  "bankName": zod.string().optional(),
  "bankAccountHolderName": zod.string().optional().describe('Name as per bank records'),
  "panNumber": zod.string().optional(),
  "bankAccountType": zod.enum(['savings', 'current', 'salary']).optional(),
  "upiId": zod.string().optional(),
  "workType": zod.enum(['permanent', 'internship', 'other']).optional(),
...
export const UpdateEmployeeBody = zod.object({
  ...
  "bankAccountNumber": zod.string().nullish(),
  "confirmBankAccountNumber": zod.string().nullish().describe('Must match bankAccountNumber when provided; not stored'),
  "bankIfscCode": zod.string().nullish(),
  "bankName": zod.string().nullish(),
  "bankAccountHolderName": zod.string().nullish().describe('Name as per bank records'),
  "panNumber": zod.string().nullish(),
